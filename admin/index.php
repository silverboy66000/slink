...
require __DIR__ . '/users/UserProfile.php';
...
use Devscreencast\ResponseClass\JsonResponse;
    ...
    if (SabaIdeaAdmin\CheckToken::checkHeaderToken($conn))
    {
        $userInfo=new SabaIdeaAdmin\UserProfile();
        $userInfo->UserProfile($conn,SabaIdeaAdmin\CheckToken::checkHeaderToken($conn));
    }
    else
    {
        $result = array(
